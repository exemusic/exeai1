...
const extraTranslations: Record<string, Record<string, string>> = {
  en: {
    ...
    processingReasoning: "Processing reasoning...",
    noResponseGenerated: "No text response was generated. Please try resending or rephrasing your message!",
    loadingModel: "Loading model {model}...",
    thinking: "Thinking...",
    ttsSpeaking: "Voice is speaking...",
    textRead: "Text read",
    ...
    helpImprove: "Help us improve ExeAi",
    whyUnhelpful: "Why was this response unhelpful?",
    thankFeedback: "Thank you for your feedback!",
    inaccurate: "Inaccurate / Hallucination",
    incorrectFormat: "Incorrect code or format",
    tooBrief: "Too brief / Ignored instructions",
    slowChat: "Slow chat / Stalled response",
    unclearExplanation: "Unclear explanation",
    addDetails: "Add specific details (optional)...",
    detailedReport: "Detailed report & files in Settings",
    skip: "Skip",
    submit: "Submit",
    dismiss: "Dismiss",
    manageProjects: "Manage projects (max. {max} per user)",
    ...
    maxProjects: "Maximum {max} projects per account",
    projectQuota: "Project quota usage:",
    projectsUsed: "Projects used",
    newProjectPlaceholder: "New project name (e.g. cashier_app)...",
    create: "Create",
    maxProjectsReached: "Maximum project limit reached. Please delete an old project first.",
    noProjects: "No projects saved yet. Enter a name above and click Create.",
    saveName: "Save name",
    ...
    updated: "Updated:",
    open: "Open",
    defaultCannotDelete: "The default project cannot be deleted",
    ...
    openingProject: "Opening project '{name}'...",
    projectLoaded: "Project '{name}' loaded successfully!",
  ...
  id: {
    ...
    thoughtFor: "Berpikir selama {duration} dtk",
    processingReasoning: "Memproses penalaran...",
    noResponseGenerated: "Tidak ada respons teks yang dibuat. Silakan kirim ulang atau ubah pertanyaan Anda.",
    loadingModel: "Memuat model {model}...",
    thinking: "Sedang berpikir...",
    ttsSpeaking: "Suara sedang diputar...",
    textRead: "Teks terbaca",
    selectAiModel: "Pilih Model AI",
    sendMessage: "Kirim pesan",
    switchAiModel: "Ganti model AI",
    appPreferences: "Preferensi Aplikasi",
    accountAppPreferences: "Akun & Preferensi Aplikasi",
    membershipStatus: "Status Keanggotaan",
    connectedViaGoogle: "Terhubung melalui Google",
    connectedAsGuest: "Terhubung sebagai Tamu",
    offlineSession: "Sesi Offline",
    guestProfile: "Profil Tamu",
    closeSettings: "Tutup Pengaturan",
    backToSettings: "Kembali ke Pengaturan",
    settingsMenu: "Menu Pengaturan",
    helpImprove: "Bantu Kami Meningkatkan ExeAi",
    whyUnhelpful: "Mengapa respons ini kurang membantu?",
    thankFeedback: "Terima kasih atas umpan baliknya!",
    inaccurate: "Tidak Akurat / Halusinasi",
    incorrectFormat: "Kode atau Format Salah",
    tooBrief: "Terlalu Singkat / Mengabaikan Instruksi",
    slowChat: "Chat Lambat / Respons Macet",
    unclearExplanation: "Penjelasan Kurang Jelas",
    addDetails: "Tambahkan detail (opsional)...",
    detailedReport: "Laporan lengkap & berkas di Pengaturan",
    skip: "Lewati",
    submit: "Kirim",
    dismiss: "Tutup",
    manageProjects: "Kelola proyek (maks. {max} per pengguna)",
    realtimeSync: "Sinkronisasi real-time",
    connecting: "Menghubungkan...",
    preview: "Pratinjau",
    code: "Kode",
    desktopPreview: "Pratinjau Desktop",
    mobilePreview: "Pratinjau Seluler",
    myProjects: "Proyek Saya",
    maxProjects: "Maksimal {max} proyek per akun",
    projectQuota: "Penggunaan kuota proyek:",
    projectsUsed: "Proyek digunakan",
    newProjectPlaceholder: "Nama proyek baru (contoh: app_kasir)...",
    create: "Buat",
    maxProjectsReached: "Batas maksimal proyek tercapai. Hapus proyek lama terlebih dahulu.",
    noProjects: "Belum ada proyek tersimpan. Masukkan nama di atas lalu tekan Buat.",
    saveName: "Simpan Nama",
    defaultProject: "Bawaan",
    renameProject: "Ubah Nama Proyek",
    filesLabel: "berkas",
    updated: "Diperbarui:",
    open: "Buka",
    defaultCannotDelete: "Proyek bawaan tidak dapat dihapus",
    deleteProject: "Hapus Proyek",
    projectNameRequired: "Nama proyek tidak boleh kosong.",
    failedCreateProject: "Gagal membuat proyek.",
    failedDeleteProject: "Gagal menghapus proyek.",
    failedRenameProject: "Gagal mengubah nama proyek.",
    projectCreated: "Proyek '{name}' berhasil dibuat!",
    openingProject: "Membuka proyek '{name}'...",
    projectLoaded: "Proyek '{name}' berhasil dimuat!",
    projectOpened: "Proyek '{name}' dibuka.",
    projectDeleted: "Proyek '{name}' berhasil dihapus.",
    projectRenamed: "Nama proyek diubah menjadi '{name}'!"
  },
  ar: {
    exeChatDisclaimer: "يمكن لـ ExeChat التسبب في أخطاء. يرجى التحقق من المعلومات الهامة.",
    scrollToBottom: "التمرير إلى الأسفل",
    thoughtFor: "التفكير لمدة {duration} ث",
    processingReasoning: "جارٍ معالجة الاستدلال...",
    noResponseGenerated: "لم يتم إنشاء رد نصي. يرجى إعادة الإرسال أو إعادة صياغة رسالتك.",
    loadingModel: "جارٍ تحميل النموذج {model}...",
    thinking: "جارٍ التفكير...",
    ttsSpeaking: "يتم تشغيل الصوت...",
    textRead: "تمت قراءة النص",
    selectAiModel: "اختر نموذج الذكاء الاصطناعي",
    sendMessage: "إرسال الرسالة",
    switchAiModel: "تغيير نموذج الذكاء الاصطناعي",
    appPreferences: "تفضيلات التطبيق",
    accountAppPreferences: "الحساب وتفضيلات التطبيق",
    membershipStatus: "حالة العضوية",
    connectedViaGoogle: "متصل عبر Google",
    connectedAsGuest: "متصل كضيف",
    offlineSession: "جلسة دون اتصال",
    guestProfile: "ملف الضيف",
    closeSettings: "إغلاق الإعدادات",
    backToSettings: "العودة إلى الإعدادات",
    settingsMenu: "قائمة الإعدادات",
    helpImprove: "ساعدنا في تحسين ExeAi",
    whyUnhelpful: "لماذا لم تكن هذه الإجابة مفيدة؟",
    thankFeedback: "شكرًا لملاحظاتك!",
    inaccurate: "غير دقيق / هلوسة",
    incorrectFormat: "رمز أو تنسيق غير صحيح",
    tooBrief: "قصير جدًا / تجاهل التعليمات",
    slowChat: "دردشة بطيئة / استجابة متوقفة",
    unclearExplanation: "شرح غير واضح",
    addDetails: "أضف تفاصيل (اختياري)...",
    detailedReport: "التقرير والملفات في الإعدادات",
    skip: "تخطي",
    submit: "إرسال",
    dismiss: "إغلاق",
    manageProjects: "إدارة المشاريع (الحد {max} لكل مستخدم)",
    realtimeSync: "مزامنة فورية",
    connecting: "جارٍ الاتصال...",
    preview: "معاينة",
    code: "رمز",
    desktopPreview: "معاينة سطح المكتب",
    mobilePreview: "معاينة الهاتف",
    myProjects: "مشاريعي",
    maxProjects: "الحد {max} مشاريع لكل حساب",
    projectQuota: "استخدام حصة المشاريع:",
    projectsUsed: "مشاريع مستخدمة",
    newProjectPlaceholder: "اسم مشروع جديد (مثال: cashier_app)...",
    create: "إنشاء",
    maxProjectsReached: "تم الوصول إلى الحد الأقصى للمشاريع. احذف مشروعًا قديمًا أولاً.",
    noProjects: "لا توجد مشاريع محفوظة. أدخل اسمًا أعلاه ثم اضغط إنشاء.",
    saveName: "حفظ الاسم",
    defaultProject: "افتراضي",
    renameProject: "إعادة تسمية المشروع",
    filesLabel: "ملفات",
    updated: "محدّث:",
    open: "فتح",
    defaultCannotDelete: "لا يمكن حذف المشروع الافتراضي",
    deleteProject: "حذف المشروع",
    projectNameRequired: "لا يمكن أن يكون اسم المشروع فارغًا.",
    failedCreateProject: "تعذر إنشاء المشروع.",
    failedDeleteProject: "تعذر حذف المشروع.",
    failedRenameProject: "تعذر إعادة تسمية المشروع.",
    projectCreated: "تم إنشاء المشروع '{name}' بنجاح!",
    openingProject: "جارٍ فتح المشروع '{name}'...",
    projectLoaded: "تم تحميل المشروع '{name}' بنجاح!",
    projectOpened: "تم فتح المشروع '{name}'.",
    projectDeleted: "تم حذف المشروع '{name}' بنجاح.",
    projectRenamed: "تمت إعادة تسمية المشروع إلى '{name}'!"
  },
  ja: {
    exeChatDisclaimer: "ExeChat は間違えることがあります。重要な情報は再確認してください。",
    scrollToBottom: "下へスクロール",
    thoughtFor: "{duration}秒間考えました",
    processingReasoning: "推論を処理中...",
    noResponseGenerated: "テキスト応答が生成されませんでした。再送信するか、質問を言い換えてください。",
    loadingModel: "モデル {model} を読み込み中...",
    thinking: "考え中...",
    ttsSpeaking: "音声を再生中...",
    textRead: "テキストを読み込み済み",
    selectAiModel: "AIモデルを選択",
    sendMessage: "メッセージを送信",
    switchAiModel: "AIモデルを変更",
    appPreferences: "アプリの設定",
    accountAppPreferences: "アカウントとアプリの設定",
    membershipStatus: "会員ステータス",
    connectedViaGoogle: "Googleで接続中",
    connectedAsGuest: "ゲストとして接続中",
    offlineSession: "オフラインセッション",
    guestProfile: "ゲストプロフィール",
    closeSettings: "設定を閉じる",
    backToSettings: "設定に戻る",
    settingsMenu: "設定メニュー",
    helpImprove: "ExeAiの改善にご協力ください",
    whyUnhelpful: "この回答が役に立たなかった理由は？",
    thankFeedback: "フィードバックありがとうございます！",
    inaccurate: "不正確 / 幻覚",
    incorrectFormat: "コードまたは形式が正しくない",
    tooBrief: "短すぎる / 指示を無視",
    slowChat: "チャットが遅い / 応答停止",
    unclearExplanation: "説明が不明確",
    addDetails: "詳細を追加（任意）...",
    detailedReport: "詳細な報告とファイルは設定から",
    skip: "スキップ",
    submit: "送信",
    dismiss: "閉じる",
    manageProjects: "プロジェクトを管理（ユーザーあたり最大{max}件）",
    ...
    myProjects: "マイプロジェクト",
    maxProjects: "アカウントあたり最大{max}件",
    projectQuota: "プロジェクト容量:",
    projectsUsed: "使用中のプロジェクト",
    newProjectPlaceholder: "新しいプロジェクト名（例: cashier_app）...",
    create: "作成",
    maxProjectsReached: "プロジェクト数の上限に達しました。古いプロジェクトを削除してください。",
    noProjects: "保存済みプロジェクトはありません。上で名前を入力して作成を押してください。",
    saveName: "名前を保存",
    defaultProject: "既定",
    ...
    updated: "更新:",
    open: "開く",
    defaultCannotDelete: "既定のプロジェクトは削除できません",
    deleteProject: "プロジェクトを削除",
    projectNameRequired: "プロジェクト名は空にできません。",
    failedCreateProject: "プロジェクトを作成できませんでした。",
    failedDeleteProject: "プロジェクトを削除できませんでした。",
    failedRenameProject: "プロジェクト名を変更できませんでした。",
    projectCreated: "プロジェクト '{name}' を作成しました！",
    openingProject: "プロジェクト '{name}' を開いています...",
    projectLoaded: "プロジェクト '{name}' を読み込みました！",
    projectOpened: "プロジェクト '{name}' を開きました。",
    projectDeleted: "プロジェクト '{name}' を削除しました。",
    projectRenamed: "プロジェクト名を '{name}' に変更しました！"
  },
  ko: {
    exeChatDisclaimer: "ExeChat은 실수를 할 수 있습니다. 중요한 정보는 다시 확인하세요.",
    scrollToBottom: "맨 아래로 스크롤",
    thoughtFor: "{duration}초 동안 생각함",
    processingReasoning: "추론 처리 중...",
    noResponseGenerated: "텍스트 응답이 생성되지 않았습니다. 다시 보내거나 메시지를 바꿔 주세요.",
    loadingModel: "모델 {model} 로드 중...",
    thinking: "생각 중...",
    ttsSpeaking: "음성을 재생 중...",
    textRead: "텍스트 읽음",
    selectAiModel: "AI 모델 선택",
    sendMessage: "메시지 보내기",
    switchAiModel: "AI 모델 변경",
    appPreferences: "앱 환경설정",
    accountAppPreferences: "계정 및 앱 환경설정",
    membershipStatus: "멤버십 상태",
    connectedViaGoogle: "Google로 연결됨",
    connectedAsGuest: "게스트로 연결됨",
    offlineSession: "오프라인 세션",
    guestProfile: "게스트 프로필",
    closeSettings: "설정 닫기",
    backToSettings: "설정으로 돌아가기",
    settingsMenu: "설정 메뉴",
    helpImprove: "ExeAi 개선을 도와주세요",
    whyUnhelpful: "이 응답이 도움이 되지 않은 이유는 무엇인가요?",
    thankFeedback: "피드백 감사합니다!",
    inaccurate: "부정확함 / 환각",
    incorrectFormat: "코드 또는 형식 오류",
    tooBrief: "너무 짧음 / 지시 무시",
    slowChat: "느린 채팅 / 응답 멈춤",
    unclearExplanation: "불명확한 설명",
    addDetails: "세부 정보 추가(선택 사항)...",
    detailedReport: "자세한 보고서와 파일은 설정에서",
    skip: "건너뛰기",
    submit: "제출",
    dismiss: "닫기",
    manageProjects: "프로젝트 관리(사용자당 최대 {max}개)",
    realtimeSync: "실시간 동기화",
    connecting: "연결 중...",
    preview: "미리보기",
    code: "코드",
    desktopPreview: "데스크톱 미리보기",
    mobilePreview: "모바일 미리보기",
    myProjects: "내 프로젝트",
    maxProjects: "계정당 최대 {max}개 프로젝트",
    projectQuota: "프로젝트 할당량 사용량:",
    projectsUsed: "사용 중인 프로젝트",
    newProjectPlaceholder: "새 프로젝트 이름(예: cashier_app)...",
    create: "만들기",
    maxProjectsReached: "프로젝트 한도에 도달했습니다. 이전 프로젝트를 삭제하세요.",
    noProjects: "저장된 프로젝트가 없습니다. 위에 이름을 입력하고 만들기를 누르세요.",
    saveName: "이름 저장",
    defaultProject: "기본",
    ...
    updated: "업데이트:",
    open: "열기",
    defaultCannotDelete: "기본 프로젝트는 삭제할 수 없습니다",
    deleteProject: "프로젝트 삭제",
    projectNameRequired: "프로젝트 이름은 비워 둘 수 없습니다.",
    failedCreateProject: "프로젝트를 만들지 못했습니다.",
    failedDeleteProject: "프로젝트를 삭제하지 못했습니다.",
    failedRenameProject: "프로젝트 이름을 변경하지 못했습니다.",
    projectCreated: "프로젝트 '{name}'을 만들었습니다!",
    openingProject: "프로젝트 '{name}' 여는 중...",
    projectLoaded: "프로젝트 '{name}'을 불러왔습니다!",
    projectOpened: "프로젝트 '{name}'을 열었습니다.",
    projectDeleted: "프로젝트 '{name}'을 삭제했습니다.",
    projectRenamed: "프로젝트 이름을 '{name}'으로 변경했습니다!"
  },
  es: {
    exeChatDisclaimer: "ExeChat puede cometer errores. Comprueba la información importante.",
    scrollToBottom: "Desplazarse hacia abajo",
    thoughtFor: "Pensó durante {duration}s",
    processingReasoning: "Procesando el razonamiento...",
    noResponseGenerated: "No se generó una respuesta de texto. Vuelve a enviar o reformula tu mensaje.",
    loadingModel: "Cargando el modelo {model}...",
    thinking: "Pensando...",
    ttsSpeaking: "Reproduciendo voz...",
    textRead: "Texto leído",
    selectAiModel: "Seleccionar modelo de IA",
    sendMessage: "Enviar mensaje",
    switchAiModel: "Cambiar modelo de IA",
    ...
    connectedViaGoogle: "Conectado con Google",
    connectedAsGuest: "Conectado como invitado",
    offlineSession: "Sesión sin conexión",
    guestProfile: "Perfil de invitado",
    closeSettings: "Cerrar configuración",
    backToSettings: "Volver a configuración",
    settingsMenu: "Menú de configuración",
    helpImprove: "Ayúdanos a mejorar ExeAi",
    whyUnhelpful: "¿Por qué esta respuesta no fue útil?",
    thankFeedback: "¡Gracias por tus comentarios!",
    inaccurate: "Inexacta / Alucinación",
    incorrectFormat: "Código o formato incorrecto",
    tooBrief: "Demasiado breve / Ignoró instrucciones",
    slowChat: "Chat lento / Respuesta detenida",
    unclearExplanation: "Explicación poco clara",
    addDetails: "Añadir detalles (opcional)...",
    detailedReport: "Informe y archivos detallados en Configuración",
    skip: "Omitir",
    submit: "Enviar",
    dismiss: "Cerrar",
    manageProjects: "Gestionar proyectos (máx. {max} por usuario)",
    realtimeSync: "Sincronización en tiempo real",
    connecting: "Conectando...",
    preview: "Vista previa",
    code: "Código",
    desktopPreview: "Vista previa de escritorio",
    mobilePreview: "Vista previa móvil",
    myProjects: "Mis proyectos",
    maxProjects: "Máximo {max} proyectos por cuenta",
    projectQuota: "Uso de cuota de proyectos:",
    projectsUsed: "Proyectos usados",
    newProjectPlaceholder: "Nuevo nombre de proyecto (p. ej., cashier_app)...",
    create: "Crear",
    maxProjectsReached: "Se alcanzó el límite de proyectos. Elimina primero un proyecto antiguo.",
    noProjects: "Aún no hay proyectos guardados. Escribe un nombre arriba y pulsa Crear.",
    saveName: "Guardar nombre",
    defaultProject: "Predeterminado",
    renameProject: "Cambiar nombre del proyecto",
    filesLabel: "archivos",
    updated: "Actualizado:",
    open: "Abrir",
    defaultCannotDelete: "El proyecto predeterminado no se puede eliminar",
    deleteProject: "Eliminar proyecto",
    projectNameRequired: "El nombre del proyecto no puede estar vacío.",
    failedCreateProject: "No se pudo crear el proyecto.",
    failedDeleteProject: "No se pudo eliminar el proyecto.",
    failedRenameProject: "No se pudo cambiar el nombre del proyecto.",
    projectCreated: "¡Proyecto '{name}' creado correctamente!",
    openingProject: "Abriendo el proyecto '{name}'...",
    projectLoaded: "¡Proyecto '{name}' cargado correctamente!",
    projectOpened: "Proyecto '{name}' abierto.",
    projectDeleted: "Proyecto '{name}' eliminado correctamente.",
    projectRenamed: "¡Proyecto renombrado a '{name}'!"
  },
  zh: {
    exeChatDisclaimer: "ExeChat 可能会犯错。请核对重要信息。",
    scrollToBottom: "滚动到探底",
    thoughtFor: "已思考 {duration} 秒",
    processingReasoning: "正在处理推理...",
    noResponseGenerated: "未生成文字回复。请重新发送或换一种说法。",
    loadingModel: "正在加载模型 {model}...",
    thinking: "正在思考...",
    ttsSpeaking: "正在播放语音...",
    textRead: "已读取文本",
    ...
    accountAppPreferences: "帐户和应用偏好设置",
    membershipStatus: "会员状态",
    connectedViaGoogle: "已通过 Google 连接",
    connectedAsGuest: "以访客身份连接",
    offlineSession: "离线会话",
    guestProfile: "访客资料",
    closeSettings: "关闭设置",
    backToSettings: "返回设置",
    settingsMenu: "设置菜单",
    helpImprove: "帮助我们改进 ExeAi",
    whyUnhelpful: "此回答为什么没有帮助？",
    thankFeedback: "感谢您的反馈！",
    inaccurate: "不准确 / 幻觉",
    incorrectFormat: "代码或格式不正确",
    tooBrief: "太简短 / 忽略指令",
    slowChat: "聊天缓慢 / 响应停滞",
    unclearExplanation: "解释不清楚",
    addDetails: "添加具体细节（可选）...",
    detailedReport: "详细报告和文件位于设置中",
    skip: "跳过",
    submit: "提交",
    dismiss: "关闭",
    manageProjects: "管理项目（每位用户最多 {max} 个）",
    realtimeSync: "实时同步",
    connecting: "正在连接...",
    preview: "预览",
    code: "代码",
    ...
    mobilePreview: "移动预览",
    myProjects: "我的项目",
    maxProjects: "每个帐户最多 {max} 个项目",
    projectQuota: "项目配额使用情况：",
    projectsUsed: "已用项目",
    newProjectPlaceholder: "新项目名称（如 cashier_app）...",
    create: "创建",
    maxProjectsReached: "已达到项目数量上限。请先删除旧项目。",
    noProjects: "尚未保存项目。在上方输入名称后点击创建。",
    saveName: "保存名称",
    defaultProject: "默认",
    renameProject: "重命名项目",
    filesLabel: "文件",
    ...
    failedCreateProject: "无法创建项目。",
    failedDeleteProject: "无法删除项目。",
    failedRenameProject: "无法重命名项目。",
    projectCreated: "项目“{name}”已创建！",
    openingProject: "正在打开项目“{name}”...",
    projectLoaded: "项目“{name}”已加载！",
    projectOpened: "项目“{name}”已打开。",
  ...
  fr: {
    ...
    thoughtFor: "Réflexion pendant {duration}s",
    processingReasoning: "Traitement du raisonnement...",
    noResponseGenerated: "Aucune réponse texte n'a été générée. Réessayez ou reformulez votre message.",
    loadingModel: "Chargement du modèle {model}...",
    thinking: "Réflexion...",
    ttsSpeaking: "Lecture vocale en cours...",
    textRead: "Texte lu",
    selectAiModel: "Sélectionner un modèle d'IA",
    sendMessage: "Envoyer le message",
    switchAiModel: "Changer de modèle d'IA",
    appPreferences: "Préférences de l'application",
    accountAppPreferences: "Compte et préférences de l'application",
    membershipStatus: "Statut de l'adhésion",
    connectedViaGoogle: "Connecté via Google",
    connectedAsGuest: "Connecté en tant qu'invité",
    offlineSession: "Session hors ligne",
    guestProfile: "Profil invité",
    closeSettings: "Fermer les paramètres",
    backToSettings: "Retour aux paramètres",
    settingsMenu: "Menu des paramètres",
    helpImprove: "Aidez-nous à améliorer ExeAi",
    whyUnhelpful: "Pourquoi cette réponse n'a-t-elle pas été utile ?",
    thankFeedback: "Merci pour votre avis !",
    inaccurate: "Imprécise / Hallucination",
    incorrectFormat: "Code ou format incorrect",
    tooBrief: "Trop bref / Instructions ignorées",
    slowChat: "Chat lent / Réponse bloquée",
    unclearExplanation: "Explication peu claire",
    addDetails: "Ajouter des détails (facultatif)...",
    detailedReport: "Rapport détaillé et fichiers dans les paramètres",
    skip: "Ignorer",
    submit: "Envoyer",
    dismiss: "Fermer",
    manageProjects: "Gérer les projets (max. {max} par utilisateur)",
    realtimeSync: "Synchronisation en temps réel",
    connecting: "Connexion...",
    preview: "Aperçu",
    code: "Code",
    desktopPreview: "Aperçu ordinateur",
    mobilePreview: "Aperçu mobile",
    myProjects: "Mes projets",
    maxProjects: "Maximum {max} projets par compte",
    projectQuota: "Utilisation du quota de projets :",
    projectsUsed: "Projets utilisés",
    newProjectPlaceholder: "Nouveau nom de projet (ex. cashier_app)...",
    create: "Créer",
    maxProjectsReached: "La limite de projets est atteinte. Supprimez d'abord un ancien projet.",
    noProjects: "Aucun projet enregistré. Saisissez un nom ci-dessus et cliquez sur Créer.",
    saveName: "Enregistrer le nom",
    defaultProject: "Par défaut",
    renameProject: "Renommer le projet",
    filesLabel: "fichiers",
    updated: "Mis à jour :",
    open: "Ouvrir",
    defaultCannotDelete: "Le projet par défaut ne peut pas être supprimé",
    deleteProject: "Supprimer le projet",
    projectNameRequired: "Le nom du projet ne peut pas être vide.",
    failedCreateProject: "Impossible de créer le projet.",
    failedDeleteProject: "Impossible de supprimer le projet.",
    failedRenameProject: "Impossible de renommer le projet.",
    projectCreated: "Projet '{name}' créé avec succès !",
    openingProject: "Ouverture du projet '{name}'...",
    projectLoaded: "Projet '{name}' chargé avec succès !",
    projectOpened: "Projet '{name}' ouvert.",
    projectDeleted: "Projet '{name}' supprimé avec succès.",
    projectRenamed: "Projet renommé en '{name}' !"
  },
  de: {
    exeChatDisclaimer: "ExeChat kann Fehler machen. Überprüfen Sie wichtige Informationen.",
    scrollToBottom: "Nach unten scrollen",
    thoughtFor: "Nachgedacht für {duration}s",
    processingReasoning: "Verarbeitung der Überlegung...",
    noResponseGenerated: "Es wurde keine Textantwort erstellt. Bitte erneut senden oder anders formulieren.",
    loadingModel: "Modell {model} wird geladen...",
    thinking: "Denkt nach...",
    ttsSpeaking: "Sprachausgabe läuft...",
    textRead: "Text gelesen",
    selectAiModel: "KI-Modell auswählen",
    sendMessage: "Nachricht senden",
    switchAiModel: "KI-Modell wechseln",
    appPreferences: "App-Einstellungen",
    accountAppPreferences: "Konto- und App-Einstellungen",
    membershipStatus: "Mitgliedschaftsstatus",
    connectedViaGoogle: "Über Google verbunden",
    connectedAsGuest: "Als Gast verbunden",
    offlineSession: "Offline-Sitzung",
    guestProfile: "Gastprofil",
    closeSettings: "Einstellungen schließen",
    backToSettings: "Zu den Einstellungen",
    settingsMenu: "Einstellungsmenü",
    helpImprove: "Hilf uns, ExeAi zu verbessern",
    whyUnhelpful: "Warum war diese Antwort nicht hilfreich?",
    thankFeedback: "Danke für dein Feedback!",
    inaccurate: "Ungenau / Halluzination",
    incorrectFormat: "Falscher Code oder Format",
    tooBrief: "Zu kurz / Anweisungen ignoriert",
    slowChat: "Langsamer Chat / Antwort hängt",
    unclearExplanation: "Unklare Erklärung",
    addDetails: "Details hinzufügen (optional)...",
    detailedReport: "Detaillierter Bericht und Dateien in Einstellungen",
    skip: "Überspringen",
    submit: "Senden",
    dismiss: "Schließen",
    manageProjects: "Projekte verwalten (max. {max} pro Benutzer)",
    ...
    maxProjects: "Maximal {max} Projekte pro Konto",
    projectQuota: "Projektkontingent:",
    projectsUsed: "Verwendete Projekte",
    newProjectPlaceholder: "Neuer Projektname (z. B. cashier_app)...",
    create: "Erstellen",
    maxProjectsReached: "Die Projektgrenze ist erreicht. Bitte zuerst ein altes Projekt löschen.",
    noProjects: "Noch keine Projekte gespeichert. Gib oben einen Namen ein und klicke auf Erstellen.",
    saveName: "Namen speichern",
    defaultProject: "Standard",
    renameProject: "Projekt umbenennen",
    filesLabel: "Dateien",
    updated: "Aktualisiert:",
    open: "Öffnen",
    defaultCannotDelete: "Das Standardprojekt kann nicht gelöscht werden",
    deleteProject: "Projekt löschen",
    projectNameRequired: "Der Projektname darf nicht leer sein.",
    failedCreateProject: "Projekt konnte nicht erstellt werden.",
    failedDeleteProject: "Projekt konnte nicht gelöscht werden.",
    failedRenameProject: "Projekt konnte nicht umbenannt werden.",
    projectCreated: "Projekt '{name}' wurde erstellt!",
    openingProject: "Projekt '{name}' wird geöffnet...",
    projectLoaded: "Projekt '{name}' wurde geladen!",
    projectOpened: "Projekt '{name}' geöffnet.",
    projectDeleted: "Projekt '{name}' wurde gelöscht.",
    projectRenamed: "Projekt wurde in '{name}' umbenannt!"
  }
};
